...
class NoPlayerContestJoin extends StatefulWidget {
  const NoPlayerContestJoin({super.key});

  @override
  State<NoPlayerContestJoin> createState() => _NoPlayerContestJoinState();
}

class _NoPlayerContestJoinState extends State<NoPlayerContestJoin> {
  @override
