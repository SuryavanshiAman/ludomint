...
class _MybankState extends State<Mybank> {
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: TextField(
                      controller: bankname,
                      style: RighteousMedium.copyWith(
                          fontSize: heights * 0.02, color: Colors.white),
                  ...
                  JellyButton(
                      onTap: () {
                        Audio.sound();
                        Bank_details(bankname.text, accountHolder.text,
                            accountName.text, ifsc.text);
                      },
                      title: 'Submit'),
                  // TextButton(
                  //     onPressed: (){
  ...
  Bank_details(String bankname, String accountHolder, String accountName,
      String ifsc) async {
    final prefs = await SharedPreferences.getInstance();
    final userid = prefs.getString("userId");
    final response = await http.post(Uri.parse(AppConstants.bankDetails),
    ...
    if (data["error"] == "200") {
        var profileApi = Provider.of<ProfileViewModel>(context, listen: false);
