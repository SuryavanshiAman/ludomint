        ...
        child:Container(
          ...
          child: Column(
            children: [
              ...
              (file != null)?
              CircleAvatar(backgroundImage:FileImage(file!), radius: heights/20,)
                  :
              image== null?
              CircleAvatar(radius: heights/20, backgroundImage: const AssetImage(AppAsset.imagesAvatar3)):
              CircleAvatar(
                radius: heights/28,
                backgroundColor: Colors.white,
                backgroundImage: NetworkImage(AppConstants.imageurl + image.toString()),
              ),
              ...
              Row(
                ...
                children: [
                  InkWell(
                      onTap:_camera,
                      child: const CircleAvatar(child: Icon(Icons.camera_alt_outlined),)

                  ),
                  InkWell(
                      onTap:_choose,
                      child: const CircleAvatar(child: Icon(Icons.folder),)
                  ),
                ],
              ),
